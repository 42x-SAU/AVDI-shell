...
/**
 * Страница политики конфиденциальности (заглушка «В разработке»).
 */
export function LegalPrivacyPage() {
  return (
    <div className="legal-doc-page">
      <section className="legal-doc-page__hero" aria-labelledby="legal-privacy-title">
        <div className="container legal-doc-page__inner">
          <h1 id="legal-privacy-title" className="legal-doc-page__title legal-doc-page__title--center">
            В разработке
          </h1>
